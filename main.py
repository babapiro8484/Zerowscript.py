...
# Zerow21 - GiriÅŸ Åifresi KontrolÃ¼
import getpass
sifre = getpass.getpass("GiriÅŸ Åifresi (nfsgang): ")
if sifre != "nfsgang":
    print("HatalÄ± ÅŸifre!")
    exit()
...
mode_server = "https://41fe423b-06a1-4435-9ead-ec01085d7126-00-3ogsrh5i5qbha.sisko.replit.dev"
"""
-------------------------------------------
MAJOR (Angka Pertama):
